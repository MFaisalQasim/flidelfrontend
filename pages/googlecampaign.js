                    ...
                    <div className="container">
                        <div className="content_one">
                            <div className="text-center">
                                <p className="create_campaign">Create Campaign(Google)</p>
                            </div>
                        </div>
                        <div className="container2">
                            ...
                            <div className="row">
                                <div className="col-md-6 col-lg-6">
                                    <div className="main">
                                        <a className="google_div">Google</a>
                                        <a className="facebook_div">Facebook</a>
                                    </div>
                                </div>
                                <div className="col-md-6 col-lg-6">
                                    <div className="main0">
                                        <a className="add_studio">Load from Ad Studio</a>
                                    </div>
                                </div>
                            </div>
